      ...
      >
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Name</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Email</FormLabel>
                  <FormControl>
                    <Input
                      type="email"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Project Title</FormLabel>
                  <FormControl>
                    <Input
                      {...field}
        ...
        <FormField
          ...
          <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Budget</FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Deadline</FormLabel>
                  <FormControl>
                    <Input
                    className="bg-zinc-800 text-slate-50 rounded-md p-3 placeholder:text-slate-50/[.5] border-none"
                      type="date"
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="font-bold text-xl text-slate-50">Attachments</FormLabel>
                  <FormControl>
            ...
            <div className="flex justify-end gap-4">
              <Button onClick={onClose} className="bg-white text-black hover:bg-slate-300 transition-all-0.3s">
                Cancel
              </Button>
              <Button className="bg-white text-black hover:bg-slate-300 transition-all-0.3s" type="submit">Place Order</Button>
            </div>
          </form>
        </Form>
      </motion.div>
