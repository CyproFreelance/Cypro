  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center backdrop-filter backdrop-blur-lg ">
      <motion.div
        ...
        className="w-[60%] h-auto bg-zinc-900 rounded-md shadow-lg p-8 full_h"
      >
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
                ...
                <FormItem className="flex flex-col">
                  ...
                  <FormControl>
                    <textarea
                      ...
                      className="textarea__ bg-zinc-800 text-slate-50 rounded-md p-3 placeholder:text-slate-50/[.5] border-none h-28 resize-none"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            />
            <div className="flex items-start justify-between order-form">
              <FormField
                control={form.control}
                name="budget"
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        className="budget__ bg-zinc-800 text-slate-50 rounded-md p-3 placeholder:text-slate-50/[.5] border-none"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        className="deadline__ bg-zinc-800 text-slate-50 rounded-md p-3 placeholder:text-slate-50/[.5] border-none"
                        type="date"
                  ...
                  <FormControl>
                    <div className="bg-zinc-800 border-dashed border-2 border-gray-300 rounded-md">
                      <input
                        type="file"
                        {...field}
                        className="file-input bg-zinc-800 text-slate-50 rounded-md p-3 placeholder:text-slate-50/[.5] border-none"
                        multiple
                      />
                    </div>
                  </FormControl>
