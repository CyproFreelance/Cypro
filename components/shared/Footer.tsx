    ...
    <footer className="text-white">
      <div className="footop flex justify-around items-start mb-6">
          ...
          <div className="navright">
            <a href="#">
              <h3 className="text-2xl font-semibold">
                CYPRO
                <span className="bg-clip-text text-transparent font-[900] bg-gradient-to-r from-[#FF1D60] to-[#C71869]">
                  STUDIO
                </span>
              </h3>
            </a>
        ...
        <div className="footcolum1 flex flex-col items-start justify-center ">
          ...
          <h3>
            <a href="/" className="hover:text-[#CCA2FD]">
              Home
            </a>
          </h3>
          <h3>
            <a href="/about" className="hover:text-[#CCA2FD]">
              About
            </a>
          </h3>
          <h3>
            <a href="/contact" className="hover:text-[#CCA2FD]">
              Contact
            </a>
          </h3>
        </div>
        <div className="footcolum1 flex flex-col items-start justify-center">
          <h1 className="foot-header text-[#de1268]">Resources</h1>
          <h3>
            <a href="/works" className="hover:text-[#CCA2FD]">
              Works
            </a>
          </h3>
          <h3>
            <a href="/blogs" className="hover:text-[#CCA2FD]">
              Blogs
            </a>
          </h3>
          <h3>
      ...
      <div className="footbootom flex justify-between items-center">
        <h4 className="text-sm max-md:hidden">
          ...
          <a
            href="https://proxyxdz.netlify.app/"
            className="text-[#FF2E58] font-semibold"
          >
            Proxy
          </a>
        </h4>
        <h4 className="text-sm">
          All Rights Reserved{" "}
          <a
            href="https://dsc.gg/cyprostudios"
            className="text-[#FF2E58] font-semibold"
          >
            Cypro Studio
          </a>
